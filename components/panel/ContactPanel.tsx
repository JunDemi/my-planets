...
const ContactPanel = () => {
  return (
    <>
      <PanelHeading index={6} title='연락처.' description='새로운 기회와 협업을 언제나 환영합니다.' />
      <div className='mt-10 grid grid-cols-2 gap-3'>
        {portfolio.contact.map((item, i) => (
          ...
          >
            ...
            <span
              className={`text-[12px] font-bold text-white ${item.url ? 'cursor-pointer underline' : 'cursor-default'}`}
